...
<body onload="curdate()"  value="<?php echo   $           ?>" >
...
<table id="pulp1">
  ...
  <tr>
    ...
    <td width="14%"><input type="number" id="brightnessiso1"      name="brightnessiso1" onkeyup="avg()"  value="<?php echo $iiso1 ?>"\> </td>
    <td rowspan="33" width="3%" >&nbsp;</td>
    <td width="14.4%"><input type="number" id="bsp11" name="bsp11" onkeyup="avg1()"  value="<?php echo $bbsp11 ?>" >  </td>  
    <td width="14.4%"><input type="number" id="bsp31" name="bsp31"onkeyup="avg2()"  value="<?php echo $bbsp31 ?>"  \> </td> 
    <td width="14.1%"><input type="number" id="ph1" name="ph1"onkeyup="avg3()"  value="<?php echo $pph1 ?>"\> </td>  
    <td width="14.1%"><input type="number" id="cp1" name="cp1"onkeyup="avg4()"  value="<?php echo $ccp1 ?>"\> </td>
    <td width="14.10%"><input type="number" id="berger1" name="berger1"onkeyup="avg5()"  value="<?php echo $bberger1 ?>" \> </td>
     </tr>
    
     <tr>
    <td><input type="text"id="time2" name="time2"  value="0800" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso2"      name="brightnessiso2" onkeyup="avg()"  value="<?php echo $iiso2 ?>"\> </td>
    
    <td><input type="number" id="bsp12" name="bsp12" onkeyup="avg1()"  value="<?php echo $bbsp12 ?>">  </td>  
    <td><input type="number" id="bsp32" name="bsp32"onkeyup="avg2()"  value="<?php echo $bbsp32 ?>" \> </td> 
    <td><input type="number" id="ph2" name="ph2"onkeyup="avg3()"  value="<?php echo $pph2 ?>"\> </td>  
    <td><input type="number" id="cp2" name="cp2"onkeyup="avg4()"  value="<?php echo $ccp2 ?>"\> </td>
    <td><input type="number" id="berger2" name="berger2"onkeyup="avg5()"  value="<?php echo $bberger2 ?>" \> </td>
    </tr>
    
     <tr>
    <td><input type="text"id="time3"  name="time3" value="0900" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso3"      name="brightnessiso3"onkeyup="avg()"  value="<?php echo   $iiso3 ?>"\> </td>
    
    <td><input type="number" id="bsp13" name="bsp13" onkeyup="avg1()"  value="<?php echo   $bbsp13 ?>">  </td>  
    <td><input type="number" id="bsp33" name="bsp33"onkeyup="avg2()"  value="<?php echo   $bbsp33 ?>" \> </td> 
    <td><input type="number" id="ph3" name="ph3"onkeyup="avg3()"  value="<?php echo   $pph3 ?>"\> </td>  
    <td><input type="number" id="cp3" name="cp3"onkeyup="avg4()"  value="<?php echo   $ccp3 ?>"\> </td>
    <td><input type="number" id="berger3" name="berger3"onkeyup="avg5()"  value="<?php echo   $bberger3 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time4" name="time4"value="1000" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso4"      name="brightnessiso4"onkeyup="avg()"  value="<?php echo   $iiso4 ?>"\> </td>
    
    <td><input type="number" id="bsp14" name="bsp14" onkeyup="avg1()"  value="<?php echo   $bbsp14 ?>">  </td>  
    <td><input type="number" id="bsp34" name="bsp34"onkeyup="avg2()"  value="<?php echo   $bbsp34 ?>" \> </td> 
    <td><input type="number" id="ph4" name="ph4"onkeyup="avg3()"  value="<?php echo   $pph4 ?>"\> </td>  
    <td><input type="number" id="cp4" name="cp4"onkeyup="avg4()"  value="<?php echo   $ccp4 ?>"\> </td>
    <td><input type="number" id="berger4" name="berger4"onkeyup="avg5()"  value="<?php echo   $bberger4 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time5" name="time5"value="1100" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso5"      name="brightnessiso5"onkeyup="avg()"  value="<?php echo   $iiso5  ?>"\> </td>
    
    <td><input type="number" id="bsp15" name="bsp15" onkeyup="avg1()"  value="<?php echo   $bbsp15  ?>">  </td>  
    <td><input type="number" id="bsp35" name="bsp35"onkeyup="avg2()"  value="<?php echo   $bbsp35 ?>" \> </td> 
    <td><input type="number" id="ph5" name="ph5"onkeyup="avg3()"  value="<?php echo   $pph5 ?>"\> </td>  
    <td><input type="number" id="cp5" name="cp5"onkeyup="avg4()"  value="<?php echo   $ccp5 ?>"\> </td>
    <td><input type="number" id="berger5" name="berger5"onkeyup="avg5()"  value="<?php echo   $bberger5 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time6" name="time6" value="1200" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso6"      name="brightnessiso6"onkeyup="avg()"  value="<?php echo   $iiso6 ?>"\> </td>
    
    <td><input type="number" id="bsp16" name="bsp16" onkeyup="avg1()"  value="<?php echo   $bbsp16 ?>">  </td>  
    <td><input type="number" id="bsp36" name="bsp36"onkeyup="avg2()"  value="<?php echo   $bbsp36 ?>" \> </td> 
    <td><input type="number" id="ph6" name="ph6"onkeyup="avg3()"  value="<?php echo   $pph6 ?>"\> </td>  
    <td><input type="number" id="cp6" name="cp6"onkeyup="avg4()"  value="<?php echo   $ccp6 ?>"\> </td>
    <td><input type="number" id="berger6" name="berger6"onkeyup="avg5()"  value="<?php echo   $bberger6 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time7"name="time7" value="1300" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso7"      name="brightnessiso7"onkeyup="avg()"  value="<?php echo   $iiso7  ?>"\> </td>
    
    <td><input type="number" id="bsp17" name="bsp17" onkeyup="avg1()"  value="<?php echo   $bbsp17  ?>">  </td>  
    <td><input type="number" id="bsp37" name="bsp37"onkeyup="avg2()"  value="<?php echo   $bbsp37  ?>" \> </td> 
    <td><input type="number" id="ph7" name="ph7"onkeyup="avg3()"  value="<?php echo   $pph7  ?>"\> </td>  
    <td><input type="number" id="cp7" name="cp7"onkeyup="avg4()"  value="<?php echo   $ccp7  ?>"\> </td>
    <td><input type="number" id="berger7" name="berger7"onkeyup="avg5()"  value="<?php echo   $bberger7 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time8"name="time8" value="1400" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso8"      name="brightnessiso8"onkeyup="avg()"  value="<?php echo   $iiso8 ?>"\> </td>
 
    <td><input type="number" id="bsp18" name="bsp18" onkeyup="avg1()"  value="<?php echo   $bbsp18 ?>">  </td>  
    <td><input type="number" id="bsp38" name="bsp38"onkeyup="avg2()"  value="<?php echo   $bbsp38  ?>" \> </td> 
    <td><input type="number" id="ph8" name="ph8"onkeyup="avg3()"  value="<?php echo   $pph8 ?>"\> </td>  
    <td><input type="number" id="cp8" name="cp8"onkeyup="avg4()"  value="<?php echo   $ccp8 ?>"\> </td>
    <td><input type="number" id="berger8" name="berger8"onkeyup="avg5()"  value="<?php echo   $bberger8 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time9"name="time9"value="1500" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso9"      name="brightnessiso9"onkeyup="avg()"  value="<?php echo   $iiso9  ?>"\> </td>
 
    <td><input type="number" id="bsp19" name="bsp19" onkeyup="avg1()"  value="<?php echo   $bbsp19  ?>">  </td>  
    <td><input type="number" id="bsp39" name="bsp39"onkeyup="avg2()"  value="<?php echo   $bbsp39  ?>" \> </td> 
    <td><input type="number" id="ph9" name="ph9"onkeyup="avg3()"  value="<?php echo   $pph9 ?>"\> </td>  
    <td><input type="number" id="cp9" name="cp9"onkeyup="avg4()"  value="<?php echo   $ccp9 ?>"\> </td>
    <td><input type="number" id="berger9" name="berger9"onkeyup="avg5()"  value="<?php echo   $bberger9 ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time10"name="time10" value="1600" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso10"      name="brightnessiso10"onkeyup="avg()"  value="<?php echo   $iiso10           ?>"\> </td>
   
    <td><input type="number" id="bsp110" name="bsp110" onkeyup="avg1()"  value="<?php echo   $bbsp110            ?>">  </td>  
    <td><input type="number" id="bsp310" name="bsp310"onkeyup="avg2()"  value="<?php echo   $bbsp310           ?>" \> </td> 
    <td><input type="number" id="ph10" name="ph10"onkeyup="avg3()"  value="<?php echo   $pph10          ?>"\> </td>  
    <td><input type="number" id="cp10" name="cp10"onkeyup="avg4()"  value="<?php echo   $ccp10           ?>"\> </td>
    <td><input type="number" id="berger10" name="berger10"onkeyup="avg5()"  value="<?php echo   $bberger10           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time11"name="time11"value="1700" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso11"      name="brightnessiso11"onkeyup="avg()"  value="<?php echo   $iiso11            ?>"\> </td>
   
    <td><input type="number" id="bsp111" name="bsp111" onkeyup="avg1()"  value="<?php echo   $bbsp111            ?>">  </td>  
    <td><input type="number" id="bsp311" name="bsp311"onkeyup="avg2()"  value="<?php echo   $bbsp311           ?>" \> </td> 
    <td><input type="number" id="ph11" name="ph11"onkeyup="avg3()"  value="<?php echo   $pph11          ?>"\> </td>  
    <td><input type="number" id="cp11" name="cp11"onkeyup="avg4()"  value="<?php echo   $ccp11           ?>"\> </td>
    <td><input type="number" id="berger11" name="berger11"onkeyup="avg5()"  value="<?php echo   $bberger11           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time12"name="time12" value="1800" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso12"      name="brightnessiso12"onkeyup="avg()"  value="<?php echo   $iiso12            ?>"\> </td>
 
    <td><input type="number" id="bsp112" name="bsp112" onkeyup="avg1()"  value="<?php echo   $bbsp112            ?>">  </td>  
    <td><input type="number" id="bsp312" name="bsp312"onkeyup="avg2()"  value="<?php echo   $bbsp312           ?>" \> </td> 
    <td><input type="number" id="ph12" name="ph12"onkeyup="avg3()"  value="<?php echo   $pph12           ?>"\> </td>  
    <td><input type="number" id="cp12" name="cp12"onkeyup="avg4()"  value="<?php echo   $ccp12           ?>"\> </td>
    <td><input type="number" id="berger12" name="berger12"onkeyup="avg5()"  value="<?php echo   $bberger12           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time13"name="time13" value="1900" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso13"      name="brightnessiso13"onkeyup="avg()"  value="<?php echo   $iiso13            ?>"\> </td>
  
    <td><input type="number" id="bsp113" name="bsp113" onkeyup="avg1()"  value="<?php echo   $bbsp113           ?>">  </td>  
    <td><input type="number" id="bsp313" name="bsp313"onkeyup="avg2()"  value="<?php echo   $bbsp313           ?>" \> </td> 
    <td><input type="number" id="ph13" name="ph13"onkeyup="avg3()"  value="<?php echo   $pph13           ?>"\> </td>  
    <td><input type="number" id="cp13" name="cp13"onkeyup="avg4()"  value="<?php echo   $ccp13          ?>"\> </td>
    <td><input type="number" id="berger13" name="berger13"onkeyup="avg5()"  value="<?php echo   $bberger13           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time14"name="time14" value="2000" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso14"      name="brightnessiso14"onkeyup="avg()"  value="<?php echo   $iiso14            ?>"\> </td>
 
    <td><input type="number" id="bsp114" name="bsp114" onkeyup="avg1()"  value="<?php echo   $bbsp114            ?>">  </td>  
    <td><input type="number" id="bsp314" name="bsp314"onkeyup="avg2()"  value="<?php echo   $bbsp314           ?>" \> </td> 
    <td><input type="number" id="ph14" name="ph14"onkeyup="avg3()"  value="<?php echo   $pph14           ?>"\> </td>  
    <td><input type="number" id="cp14" name="cp14"onkeyup="avg4()"  value="<?php echo   $ccp14           ?>"\> </td>
    <td><input type="number" id="berger14" name="berger14"onkeyup="avg5()"  value="<?php echo   $bberger14          ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time15"name="time15" value="2100" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso15" name="brightnessiso15" onkeyup="avg()"  value="<?php echo   $iiso15           ?>"\> </td>
 
    <td><input type="number" id="bsp115" name="bsp115" onkeyup="avg1()"  value="<?php echo   $bbsp115            ?>">  </td>  
    <td><input type="number" id="bsp315" name="bsp315"onkeyup="avg2()"  value="<?php echo   $bbsp315           ?>" \> </td> 
    <td><input type="number" id="ph15" name="ph15"onkeyup="avg3()"  value="<?php echo   $pph15           ?>"\> </td>  
    <td><input type="number" id="cp15" name="cp15"onkeyup="avg4()"  value="<?php echo   $ccp15           ?>"\> </td>
    <td><input type="number" id="berger15" name="berger15"onkeyup="avg5()"  value="<?php echo   $bberger15           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time16" name="time16"value="2200" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso16"      name="brightnessiso16"onkeyup="avg()"  value="<?php echo   $iiso16            ?>"\> </td>

    <td><input type="number" id="bsp116" name="bsp116" onkeyup="avg1()"  value="<?php echo   $bbsp116            ?>">  </td>  
    <td><input type="number" id="bsp316" name="bsp316"onkeyup="avg2()"  value="<?php echo   $bbsp316          ?>" \> </td> 
    <td><input type="number" id="ph16" name="ph16"onkeyup="avg3()"  value="<?php echo   $pph16            ?>"\> </td>  
    <td><input type="number" id="cp16" name="cp16"onkeyup="avg4()"  value="<?php echo   $ccp16           ?>"\> </td>
    <td><input type="number" id="berger16" name="berger16"onkeyup="avg5()"  value="<?php echo   $bberger16           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time17" name="time17"value="2300" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso17"      name="brightnessiso17"onkeyup="avg()"  value="<?php echo   $iiso17            ?>"\> </td>
 
    <td><input type="number" id="bsp117" name="bsp117" onkeyup="avg1()"  value="<?php echo   $bbsp117            ?>">  </td>  
    <td><input type="number" id="bsp317" name="bsp317"onkeyup="avg2()"  value="<?php echo   $bbsp317           ?>" \> </td> 
    <td><input type="number" id="ph17" name="ph17"onkeyup="avg3()"  value="<?php echo   $pph17           ?>"\> </td>  
    <td><input type="number" id="cp17" name="cp17"onkeyup="avg4()"  value="<?php echo   $ccp17           ?>"\> </td>
    <td><input type="number" id="berger17" name="berger17"onkeyup="avg5()"  value="<?php echo   $bberger17           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time18"name="time18" value="0000" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso18"      name="brightnessiso18"onkeyup="avg()"  value="<?php echo   $iiso18            ?>"\> </td>

    <td><input type="number" id="bsp118" name="bsp118" onkeyup="avg1()"  value="<?php echo   $bbsp118            ?>">  </td>  
    <td><input type="number" id="bsp318" name="bsp318"onkeyup="avg2()"  value="<?php echo   $bbsp318           ?>" \> </td> 
    <td><input type="number" id="ph18" name="ph18"onkeyup="avg3()"  value="<?php echo   $pph18           ?>"\> </td>  
    <td><input type="number" id="cp18" name="cp18"onkeyup="avg4()"  value="<?php echo   $ccp18           ?>"\> </td>
    <td><input type="number" id="berger18" name="berger18"onkeyup="avg5()"  value="<?php echo   $bberger18           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time19"name="time19" value="0100" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso19"      name="brightnessiso19"onkeyup="avg()"  value="<?php echo   $iiso19            ?>"\> </td>

    <td><input type="number" id="bsp119" name="bsp119" onkeyup="avg1()"  value="<?php echo   $bbsp119            ?>">  </td>  
    <td><input type="number" id="bsp319" name="bsp319"onkeyup="avg2()"  value="<?php echo   $bbsp319           ?>" \> </td> 
    <td><input type="number" id="ph19" name="ph19"onkeyup="avg3()"  value="<?php echo   $pph19           ?>"\> </td>  
    <td><input type="number" id="cp19" name="cp19"onkeyup="avg4()"  value="<?php echo   $ccp19           ?>"\> </td>
    <td><input type="number" id="berger19" name="berger19"onkeyup="avg5()"  value="<?php echo   $bberger19           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time20" name="time20"value="0200" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso20"      name="brightnessiso20"onkeyup="avg()"  value="<?php echo   $iiso20           ?>"\> </td>

    <td><input type="number" id="bsp120" name="bsp120" onkeyup="avg1()"  value="<?php echo   $bbsp120            ?>">  </td>  
    <td><input type="number" id="bsp320" name="bsp320"onkeyup="avg2()"  value="<?php echo   $bbsp320           ?>" \> </td> 
    <td><input type="number" id="ph20" name="ph20"onkeyup="avg3()"  value="<?php echo   $pph20           ?>"\> </td>  
    <td><input type="number" id="cp20" name="cp20"onkeyup="avg4()"  value="<?php echo   $ccp20           ?>"\> </td>
    <td><input type="number" id="berger20" name="berger20"onkeyup="avg5()"  value="<?php echo   $bberger20           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time21"name="time21" value="0300" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso21"      name="brightnessiso21"onkeyup="avg()"  value="<?php echo   $iiso21            ?>"\> </td>
 
    <td><input type="number" id="bsp121" name="bsp121" onkeyup="avg1()"  value="<?php echo   $bbsp121            ?>">  </td>  
    <td><input type="number" id="bsp321" name="bsp321"onkeyup="avg2()"  value="<?php echo   $bbsp321           ?>" \> </td> 
    <td><input type="number" id="ph21" name="ph21"onkeyup="avg3()"  value="<?php echo   $pph21          ?>"\> </td>  
    <td><input type="number" id="cp21" name="cp21"onkeyup="avg4()"  value="<?php echo   $ccp21           ?>"\> </td>
    <td><input type="number" id="berger21" name="berger21"onkeyup="avg5()"  value="<?php echo   $bberger21           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text"id="time22"name="time22" value="0400" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso22"      name="brightnessiso22"onkeyup="avg()"  value="<?php echo   $iiso22            ?>"\> </td>

    <td><input type="number" id="bsp122" name="bsp122" onkeyup="avg1()"  value="<?php echo   $bbsp122            ?>">  </td>  
    <td><input type="number" id="bsp322" name="bsp322"onkeyup="avg2()"  value="<?php echo   $bbsp322           ?>" \> </td> 
    <td><input type="number" id="ph22" name="ph22"onkeyup="avg3()"  value="<?php echo   $pph22           ?>"\> </td>  
    <td><input type="number" id="cp22" name="cp22"onkeyup="avg4()"  value="<?php echo   $ccp22           ?>"\> </td>
    <td><input type="number" id="berger22" name="berger22"onkeyup="avg5()"  value="<?php echo   $bberger22           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="test" id="time23" name="time23" value="0500" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso23"      name="brightnessiso23"onkeyup="avg()"  value="<?php echo   $iiso23            ?>"\> </td>
 
    <td><input type="number" id="bsp123" name="bsp123" onkeyup="avg1()"  value="<?php echo   $bbsp123            ?>">  </td>  
    <td><input type="number" id="bsp323" name="bsp323"onkeyup="avg2()"  value="<?php echo   $bbsp323           ?>" \> </td> 
    <td><input type="number" id="ph23" name="ph23"onkeyup="avg3()"  value="<?php echo   $pph23           ?>"\> </td>  
    <td><input type="number" id="cp23" name="cp23"onkeyup="avg4()"  value="<?php echo   $ccp23           ?>"\> </td>
    <td><input type="number" id="berger23" name="berger23"onkeyup="avg5()"  value="<?php echo   $bberger23           ?>" \> </td>
    </tr>
    
    <tr>
    <td><input type="text" id="time24" name="time24"value="0600" readonly="readonly"></td>  
    <td><input type="number" id="brightnessiso24"      name="brightnessiso24" onkeyup="avg()"  value="<?php echo   $iiso24            ?>"\> </td>

    <td><input type="number" id="bsp124" name="bsp124" onkeyup="avg1()"  value="<?php echo   $bbsp124            ?>">  </td>  
    <td><input type="number" id="bsp324" name="bsp324"onkeyup="avg2()"  value="<?php echo   $bbsp324           ?>" \> </td> 
    <td><input type="number" id="ph24" name="ph24"onkeyup="avg3()"  value="<?php echo   $pph24           ?>"\> </td>  
    <td><input type="number" id="cp24" name="cp24"onkeyup="avg4()"  value="<?php echo   $ccp24           ?>"\> </td>
    <td><input type="number" id="berger24" name="berger24"onkeyup="avg5()"  value="<?php echo   $bberger24           ?>" \> </td>
    </tr>
