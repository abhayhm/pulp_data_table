...
header("location:home.php");
    ...
    $query1="update pulptime set brightness='$iso1', bsp1='$bnsp11', bsp3='$bnsp31', ph='$ph1', cp='$cp1', whiteness='$whiteness1'  where date='$date' and time='$time1'";
    $run=mysqli_query($connection,$query1)or die('Error1');
    
    $query2="update pulptime set brightness='$iso2', bsp1='$bnsp12', bsp3='$bnsp32', ph='$ph2', cp='$cp2', whiteness='$whiteness2' where date='$date' and time='$time2'";
    $run=mysqli_query($connection,$query2)or die('Error2');
    
    $query1="update pulptime set brightness='$iso3', bsp1='$bnsp13', bsp3='$bnsp33', ph='$ph3', cp='$cp3', whiteness='$whiteness3' where date='$date' and time='$time3'";
    $run=mysqli_query($connection,$query1)or die('Error3');
    
    $query1="update pulptime set brightness='$iso4', bsp1='$bnsp14', bsp3='$bnsp34', ph='$ph4', cp='$cp4', whiteness='$whiteness4' where date='$date' and time='$time4'";
    $run=mysqli_query($connection,$query1)or die('Error4');
    
    $query1="update pulptime set brightness='$iso5', bsp1='$bnsp15', bsp3='$bnsp35', ph='$ph5', cp='$cp5', whiteness='$whiteness5' where date='$date' and time='$time5'";
    $run=mysqli_query($connection,$query1)or die('Error5');
    
    $query1="update pulptime set brightness='$iso6', bsp1='$bnsp16', bsp3='$bnsp36', ph='$ph6', cp='$cp6', whiteness='$whiteness6' where date='$date' and time='$time6'";
    $run=mysqli_query($connection,$query1)or die('Error6');
    
    $query1="update pulptime set brightness='$iso7', bsp1='$bnsp17', bsp3='$bnsp37', ph='$ph7', cp='$cp7', whiteness='$whiteness7' where date='$date' and time='$time7'";
    $run=mysqli_query($connection,$query1)or die('Error7');
    
    $query1="update pulptime set brightness='$iso8', bsp1='$bnsp18', bsp3='$bnsp38', ph='$ph8', cp='$cp8', whiteness='$whiteness8' where date='$date' and time='$time8'";
    $run=mysqli_query($connection,$query1)or die('Error8');
    
    $query1="update pulptime set brightness='$iso9', bsp1='$bnsp19', bsp3='$bnsp39', ph='$ph9', cp='$cp9', whiteness='$whiteness9' where date='$date' and time='$time9'";
    $run=mysqli_query($connection,$query1)or die('Error9');
    
    $query1="update pulptime set brightness='$iso10', bsp1='$bnsp110', bsp3='$bnsp310', ph='$ph10', cp='$cp10', whiteness='$whiteness10' where date='$date' and time='$time10'";
    $run=mysqli_query($connection,$query1)or die('Error10');
    
    $query1="update pulptime set brightness='$iso11', bsp1='$bnsp111', bsp3='$bnsp311', ph='$ph11', cp='$cp11', whiteness='$whiteness11' where date='$date' and time='$time11'";
    $run=mysqli_query($connection,$query1)or die('Error11');
    
    $query1="update pulptime set brightness='$iso12', bsp1='$bnsp112', bsp3='$bnsp312', ph='$ph12', cp='$cp12', whiteness='$whiteness12' where date='$date' and time='$time12'";
    $run=mysqli_query($connection,$query1)or die('Error12');
    
    $query1="update pulptime set brightness='$iso13', bsp1='$bnsp113', bsp3='$bnsp313', ph='$ph13', cp='$cp13', whiteness='$whiteness13' where date='$date' and time='$time13'";
    $run=mysqli_query($connection,$query1)or die('Error13');
    
    $query1="update pulptime set brightness='$iso14', bsp1='$bnsp114', bsp3='$bnsp314', ph='$ph14', cp='$cp14', whiteness='$whiteness14' where date='$date' and time='$time14'";
    $run=mysqli_query($connection,$query1)or die('Error14');
    
    $query1="update pulptime set brightness='$iso15', bsp1='$bnsp115', bsp3='$bnsp315', ph='$ph15', cp='$cp15', whiteness='$whiteness15' where date='$date' and time='$time15'";
    $run=mysqli_query($connection,$query1)or die('Error15');
    
    $query1="update pulptime set brightness='$iso16', bsp1='$bnsp116', bsp3='$bnsp316', ph='$ph16', cp='$cp16', whiteness='$whiteness16' where date='$date' and time='$time16'";
    $run=mysqli_query($connection,$query1)or die('Error16');
    
    $query1="update pulptime set brightness='$iso17', bsp1='$bnsp117', bsp3='$bnsp317', ph='$ph17', cp='$cp17', whiteness='$whiteness17' where date='$date' and time='$time17'";
    $run=mysqli_query($connection,$query1)or die('Error17');
    
    $query1="update pulptime set brightness='$iso18', bsp1='$bnsp118', bsp3='$bnsp318', ph='$ph18', cp='$cp18', whiteness='$whiteness18' where date='$date' and time='$time18'";
    $run=mysqli_query($connection,$query1)or die('Error18');
    
    $query1="update pulptime set brightness='$iso19', bsp1='$bnsp119', bsp3='$bnsp319', ph='$ph19', cp='$cp19', whiteness='$whiteness19' where date='$date' and time='$time19'";
    $run=mysqli_query($connection,$query1)or die('Error19');
    
    $query1="update pulptime set brightness='$iso20', bsp1='$bnsp120', bsp3='$bnsp320', ph='$ph20', cp='$cp20', whiteness='$whiteness20' where date='$date' and time='$time20'";
    $run=mysqli_query($connection,$query1)or die('Error20');
    
    $query1="update pulptime set brightness='$iso21', bsp1='$bnsp121', bsp3='$bnsp321', ph='$ph21', cp='$cp21', whiteness='$whiteness21' where date='$date' and time='$time21'";
    $run=mysqli_query($connection,$query1)or die('Error21');
    
    $query1="update pulptime set brightness='$iso22', bsp1='$bnsp122', bsp3='$bnsp322', ph='$ph22', cp='$cp22', whiteness='$whiteness22' where date='$date' and time='$time22'";
    $run=mysqli_query($connection,$query1)or die('Error22');
    
    $query1="update pulptime set brightness='$iso23', bsp1='$bnsp123', bsp3='$bnsp323', ph='$ph23', cp='$cp23', whiteness='$whiteness23' where date='$date' and time='$time23'";
    $run=mysqli_query($connection,$query1)or die('Error23');
    
    $query1="update pulptime set brightness='$iso24', bsp1='$bnsp124', bsp3='$bnsp324', ph='$ph24', cp='$cp24', whiteness='$whiteness24' where date='$date' and time='$time24'";
    $run=mysqli_query($connection,$query1)or die('Error24');
